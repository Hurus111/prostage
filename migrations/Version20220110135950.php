 ...
 */
final class Version20220110135950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entreprise (id INT AUTO_INCREMENT NOT NULL, code INT NOT NULL, nom VARCHAR(100) NOT NULL, adresse VARCHAR(300) NOT NULL, activite VARCHAR(100) NOT NULL, siteweb VARCHAR(300) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT NOT NULL, code INT NOT NULL, titre VARCHAR(300) NOT NULL, mission VARCHAR(1000) NOT NULL, email VARCHAR(100) NOT NULL, INDEX IDX_C27C9369A4AEAFEA (entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
