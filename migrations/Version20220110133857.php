 ...
 */
final class Version20220110133857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stage ADD formation_id INT DEFAULT NULL, ADD entreprise_stage_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stage DROP formation_id, DROP entreprise_stage_id');
    }
}
