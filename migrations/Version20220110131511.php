 ...
 */
final class Version20220110131511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stage ADD formation_id INT DEFAULT NULL, ADD entreprise_id INT DEFAULT NULL, ADD formation_stage_id INT DEFAULT NULL, ADD entreprise_stage_id INT DEFAULT NULL');
